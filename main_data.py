"""Build, inspect, and maintain the self-contained Dataset."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    validate = actions.add_parser("validate", help="validate the Dataset without changing it")
    validate.add_argument("--dataset", type=Path, default=Path("dataset"))
    ...
    parser.set_defaults(action="validate", dataset=Path("dataset"))
    return parser
