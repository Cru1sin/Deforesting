...
import pandas as pd
import torch
from export_optimal_rgb_views import build_optimal_view_manifest
...
from frost_analysis.dataset_metadata import read_catalog
...
from frost_analysis.visualization import RGB_CAMERA_ORDER
    ...
    *,
    ...
    for name in backbones:
        ...
        matrix = extract_embeddings(
            paths, model, transform, device=device, batch_size=batch_size
        )
