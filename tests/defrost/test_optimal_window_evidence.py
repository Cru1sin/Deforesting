...
from frost_analysis.dataset_metadata import following_cycle_names
from frost_analysis.defrost_cost import partial_pool_group_estimates


def _module():  # type: ignore[no-untyped-def]
    path = Path("scripts/defrost/analyze_optimal_window_evidence.py")
...
def test_render_all_cost_publications_passes_explicit_cloud_root(
    ...
    module = _module()
    import frost_analysis.dataset_images as dataset_images
